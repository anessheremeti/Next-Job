            ...
            <div className='flex flex-col gap-10 border border-[#216F4C] rounded-md py-4 px-6 w-full'>
                <div className='flex flex-col md:flex-row gap-10 items-center md:items-start justify-between'>
                    ...
                    <div className='flex flex-col gap-2 text-center md:text-left'>
                        <h2 className='font-poppins font-semibold text-xl'>YouTube Thumbnail Design (Trial Project)</h2>
                        <p className='font-poppins '>I'm looking for a YouTube thumbnail design for a single upcoming video on my channel.</p>
                    </div>
                    </div>
                    <div className='flex flex-col gap-2 text-center md:text-left'>
                    ...
                    <div>
                        <h2 className='text-2xl font-sans font-bold md:mr-12'>$29</h2>
                    </div>
                </div>
