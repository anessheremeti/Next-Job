            ...
            <div className='flex justify-center items-center gap-10'>
              <div className='flex flex-col border border-[#216F4C] p-4 rounded-xl gap-4'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <button className='flex self-start bg-[#216F4C] mt-3 text-white font-poppins px-5 rounded-full hover:bg-transparent hover:border hover:border-[#216F4C] hover:[#216F4C]'>
                      From: $65.00
                    </button>
                  </div>
              </div>
